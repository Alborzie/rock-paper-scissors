...
main_icon = tk.PhotoImage(file="main logo.png U")
rock_icon = tk.PhotoImage(file="rock.png U")
paper_icon = tk.PhotoImage(file="paper.png U")
scissors_icon = tk.PhotoImage(file="scissors.png U")

win.geometry("350x350")
win.title("rock, paper, scissors, Which would you choose?")
